...
const columns = [
  ...
  { field: "profit", headerName: "Profit", flex: 1, valueFormatter: (params) => `₹${params.value}` },
  { field: "credit", headerName: "Credit", flex: 1, valueFormatter: (params) => `₹${params.value}` },
  { field: "total", headerName: "Total", flex: 1, valueFormatter: (params) => `₹${params.value}` },
